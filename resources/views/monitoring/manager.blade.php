                    ...
                    @if($qualCargo)
                        <div class="panel panel-secondary">
                            ...
                            <div class="panel-body">
                                {{-- Relatórios em Cards --}}
                                <div class="col-md-3">
                                    <div class="widget @if($media > 94 ) widget-success @elseif($media > 89) widget-primary @else widget-danger @endif widget-padding-sm widget-carousel">
                                        <div class="owl-carousel">
                                            <a href="javascript:$('#modalAnaliticoMonitoria').show()" class="text-light">
                                                ...
                                                <div class="widget-data">
                                                    ...
                                                    <div class="widget-subtitle">Relatório Analítico</div>
                                                </div>
                                            </a>
                                            <a href="javascript:$('#modalAnaliticoMonitoria').show()" class="text-light">
                                                <div class="widget-subtitle">NCG neste Mês</div>
                                                <div class="widget-big-int"><span class="num-count">{{@$quartis[1]->count}}</span></div>
                                            </a>
                                            <a href="javascript:$('#modalAnaliticoMonitoria').show()" class="text-light">
                                ...
                                <div class="col-md-3">
                                    <div class="widget widget-warning widget-carousel">
                                        <div class="owl-carousel" id="owl-example">
                                            <div onclick="$('#modalMonitoringSign').show()">
                                                <div class="widget-subtitle">Relatório por</div>
                                                <div class="widget-title"><span class="fa fa-pencil">&nbsp;Assinaturas</span></div>
                                                <div class="widget-int">{{$signs}}</div>
                                            </div>
                                            @if(in_array(Auth::user()->cargo_id,[15,1]))
                                            <a href="{{route('FindMonitoring')}}" class="text-light">
                                                <div>
                                                    <div class="widget-subtitle">Relatório por</div>
                                                    <div class="widget-title"><span class="fa fa-sitemap">&nbsp;Supervisor/Equipe</span></div>
                                                    <div class="widget-subtitle">Equipes {{$supers}}</div>
                                                </div>
                                            </a>
                                            <a href="{{route('PostFeedbacksEvolutionOperator')}}" class="text-light">
                                                <div>
                                                    <div class="widget-subtitle">Relatório por</div>
                                                    <div class="widget-title"><span class="fa fa-users"></span>&nbsp;Operador</span></div>
                                                    <div class="widget-subtitle">Operadores {{$operators}}</div>
                                                </div>
                                            </a>
                                            <a href="{{route('FindMonitoringByAgent')}}" class="text-light">
                                                <div>
                                                    <div class="widget-subtitle">Relatório por</div>
                                                    <div class="widget-title"><span class="fa fa-flag"></span>&nbsp;Monitores</span></div>
                                                    <div class="widget-subtitle">Monitores {{$agents}}</div>
                                                </div>
                                            </a>
                                            @else
                                            <form id="reportSup" method="POST" action="{{route('PostFeedbacksFindMonitoring',[Auth::id()])}}">
                                                @csrf
                                                <div>
                                                    <div class="widget-subtitle">Relatório por</div>
                                                    <div class="widget-title"><span class="fa fa-sitemap">&nbsp;Supervisor/Equipe</span></div>
                                ...
                                <a class="col-md-3 text-dark">
                                    <div class="widget" onclick="window.location.href='{{route('GetMonitoriasMediaSegments')}}'">
                                        <div class="widget-subtitle text-dark">Relatório por</div>
                                        <div class="widget-title text-dark"><span class="fa fa-sitemap"></span> Áreas</div>
                                        <div class="widget-subtitle owl-carousel  text-dark">
                                            <div>
                                                <button class="btn btn-xs btn-outline-dark" onclick="window.location.href='{{route('GetMonitoriasMediaSegments')}}'">
                                                    Carteiras
                                                </button>
                                            </div>
                                            <div>
                        ...
                        <div class="panel panel-colorful">
                            ...
                            <div class="panel-body text-center" style="overflow-x:scroll">
                                ...
                                <div class="col" style="border: solid 0.5px gray">
                                	<iframe width="800" height="573.5" src="https://app.powerbi.com/view?r=eyJrIjoiMDE5OGNmMWEtN2E3Ni00MDNhLThkNjktMzA2ZmIxMTc1MDFiIiwidCI6ImZkYzJlZjNkLWEzZDEtNDA1OC1hOTA4LTAxMWMxMTcxZTYxNiJ9" frameborder="0" allowFullScreen="true"></iframe>
                                </div>
                            </div>
                        </div>
                    @endif
...
<script type="text/javascript">
    ...
    $(() => {
        Morris.Donut({
        element: 'quartisChart',
            data: [
                @forelse($quartis as $item)
                    @if($item->count > 0)
                        {"label": "{{$item->quartil}}", "value": {{$item->count}}},
                    @endif
                @empty
                    {"label": "-", "value": 0}
                @endforelse
