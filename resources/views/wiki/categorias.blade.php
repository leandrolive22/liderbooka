            ...
            <div class="content-frame-body content-frame-body-left">
                ...
                <div class="pull-right push-up-10">
                    <div class="btn-group">
                        ...
                        <button class="btn btn-primary"><span class="fa fa-trash-o"></span> Deletar</button>
                    </div>                            
                </div>
                
                <div id="carousel" style="width:100%;height:100%;"  class="owl-carousel">
                    <div class="item-video" data-merge="1"><a class="owl-video" href="https://vimeo.com/23924346"></a></div>
                    <div class="item-video" data-merge="1"><a class="owl-video" href="https://www.youtube.com/watch?v=JpxsRwnRwCQ"></a></div>
                    <div class="item-video" data-merge="1"><a class="owl-video" href="https://www.youtube.com/watch?v=FBu_jxT1PkA"></a></div>
                    ...
                    <div class="item-video" data-merge="1"><a class="owl-video" href="https://www.youtube.com/watch?v=g3J4VxWIM6s"></a></div>
                    <div class="item-video" data-merge="1"><a class="owl-video" href="https://www.youtube.com/watch?v=0fhoIate4qI"></a></div>
                    <div class="item-video" data-merge="1"><a class="owl-video" href="https://www.youtube.com/watch?v=EF_kj2ojZaE"></a></div>
                </div>
...
!(function (a, b, c, d) {
	...
	(m = {
		...
		(e.prototype.onDragStart = function (d) {
			var e, g, h, i;
			if (
				((e = d.originalEvent || d || b.event), 3 === e.which || this.state.isTouch)
			)
				return !1;
			if (
					...
					.each(
						a.proxy(function (a, b) {
							(b = this.prepare(b)),
								...
								this._mergers.push(
									1 *
										b.find("[data-merge]").andSelf("[data-merge]").attr("data-merge") || 1
								);
						}, this)
					),
				this.reset(
			...
			(b = b === d ? this._items.length : this.normalize(b, !0)),
				...
				0 === this._items.length || b === this._items.length
					? (this.$stage.append(a),
					  this._items.push(a),
					  this._mergers.push(
							1 * a.find("[data-merge]").andSelf("[data-merge]").attr("data-merge") ||
								1
					  ))
			...
			(d.prototype.thumbnail = function (b, c) {
				...
				return (
					...
					h.length
						...
						: void ("youtube" === c.type
								? ((f = "https://img.youtube.com/vi/" + c.id + "/hqdefault.jpg"), l(f))
								: "vimeo" === c.type &&
								  a.ajax({
										type: "GET",
		...
		(b.Defaults = {
			...
			(b.prototype.draw = function () {
				var b,
					...
					f =
						(this._core.$stage.children(), this._core.relative(this._core.current()));
				if (
					(!e.nav ||
						e.loop ||
						e.navRewind ||
			...
			(b.prototype.onTrigger = function (b) {
				...
				b.page = {
					...
					size:
						c && (c.center || c.autoWidth || c.dotData ? 1 : c.dotsEach || c.items)
				};
			}),
