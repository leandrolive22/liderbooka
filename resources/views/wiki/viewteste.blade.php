                        ...
                        <div style="height: 100px;  width: 100%;" class="panel panel-success panel-hidden-controls">
                            <div class="panel-heading">
                                ...
                                <div class="panel-body">
                                    <code id="preventivo"> <a onclick="hashtags()" href="#" > #Preventivo </a> </code> <code><a> #Consignado </a>  </code>
                                </div>
                            </div>
                            <!-- PAGE CONTENT WRAPPER -->
                            <div class="page-content-wrap">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <label class="mr-sm-2 sr-only" for="inlineFormCustomSelect">Campos</label>
                                            <label class="icheck">
                                            ...
                                            <div class="input-group mb-3 col-md-6 pull-right">
                                                <input type="text" class="form-control col-md-11" name="valor" id="valor" placeholder="pesquisar" aria-label="Pesquisar" aria-describedby="basic-addon2">
                                                <div class="input-group-append">
                                                    <span class="input-group-text" onclick="pesquisar(String($('#campo').val()),String($('input#valor').val()),String($('#tipo').val()),String($('#ilha').val()));" id="pesquisarFiltro"><i class="fa fa-search"></i></span>
                                                </div>
                                            </div>
                                        </div>
...
<script>
    ...
    function pesquisar(campo, valor, tipo)
    {
        ...
        if(valor.length >= 3) {
            ...
            var tipo = $('#tipo').val();
            var url = "{{ route('pesquisarMaterials',['campo' => '--', 'valor' => '---'])}}".replace('--',campo).replace('---',valor)
            $.ajax({
                url:url,
                method:'GET',
    ...
    function hashtags(){
      valor = $('#preventivo').val()  
      $('#tbodypesquisa').html(valor)
  }
