  ...
  <body>
    <form name="cal" onsubmit="return false" >
      <div class="card">
        <table>
          <tr>
            <td align="left"><label>CALCULADORA REDUÇÃO DE LIMITES</label></td>
            <td align="right"><button class="btn btn-secondary btn-sm float-right" type="reset">limpar</button></td>
          </tr>
        </table>
        <div class="input-group">
          <div class="input-group-prepend">
            <span class="input-group-text vermelho">Limite Atual Cheque Especial (R$)</span>
          </div>
          <input type="text" id="n1" class="form-control" placeholder="R$">
        </div>
        <div class="input-group">
          <div class="input-group-prepend">
            <span class="input-group-text vermelho">Taxa de Redução em (%)</span>
          </div>
          <input type="text" id="n2" value="20" class="form-control" disabled>
        </div>
        <div class="input-group">
          <div class="input-group-prepend">
            <span class="input-group-text cinza">Novo limite s ser informado (R$)</span>
          </div>
          <input type="text" id="resultado" class="form-control" placeholder="R$" disabled>
        </div>
        <div class="input-group" style="margin-top:15px;">
          <div class="input-group-prepend">
            <span class="input-group-text vermelho">Limite Atual Cartão (R$)</span>
          </div>
          <input type="text" id="num1" class="form-control" placeholder="R$">
        </div>
        <div class="input-group">
          <div class="input-group-prepend">
            <span class="input-group-text vermelho">Taxa de Redução em (%)</span>
          </div>
          <input type="text" id="num2" value="60" class="form-control" disabled>
        </div>
        <div class="input-group">
          <div class="input-group-prepend">
            <span class="input-group-text cinza">Novo limite s ser informado (R$)</span>
          </div>
          <input type="text" id="resultado2" class="form-control" placeholder="R$" disabled>
        </div>
