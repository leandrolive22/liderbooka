                    ...
                    <div class="panel panel-{{Auth::user()->css}}">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Editar Material <strong>{{$material['name']}}</strong></h3>
                                <ul class="panel-controls">
                                    <li><a href="#" class="panel-collapse"><span class="fa fa-angle-down"></span></a></li>
                                </ul>
                            </div>
                            <div class="panel-body">
                                <form enctype="multipart/form-data" method="POST" action="{{ route('saveFileScript',['user' => Auth::user()->id] ) }}">
                                    @csrf
                                    <input type="hidden" name="id" value="{{$material->id}}">
                                    <input type="hidden" name="ilha" value="{{$material->ilha_id}}">
