                        ...
                        <div class="content-frame">
                            ...
                            <div class="content-frame-top">
                                <div class="page-title">
                                    <a href="{{url()->previous()}}"><h2><span class="fa fa-arrow-circle-o-left"></span> Incluir Circular</h2></a>
                                </div>
                                            ...
                                            <div class="form-row">
                                                <div class="panel border">
                                                    <div class="panel-body">
                                                        <form method="POST" onsubmit="return false" enctype="multipart/form-data" class="form-horizontal">
                                                        @csrf
                                                            ...
                                                            <div class="form-group">
                                                                <label for="number" class="pull-left">Numero da Circular</label>
                                                                <div class="input-group">
                                                                        <input required type="number" name="number" class="form-control col-md-2 " id="number" placeholder="Número">
                                                                        <input type="text" class="form-control col-md-1" value="/">
                                                                        <select required class="form-control col-md-9" name="year" id="year">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select multiple required class="form-control select" id="ilha_id" name="ilha_id">
                                                            ...
                                                            <div class="panel panel-default form-group">
                                                                <div class="panel-body">
                                                                    <h3><span class="fa fa-mail-forward"></span> Selecionar Circular</h3>
                                                                    <div class="form-group">
                                                                        <div class="col-md-12">
                                                                            <label>Selecione a Circular</label>
                                                                            <input type="file" class="" name="circular" id="circular" data-preview-file-type="any"/>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <button type="button" onclick="save()" id="sendBtn" class="btn btn-primary col-md-12">Criar</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script type="text/javascript">
        function save() {
            ...
            if($("#cargo_id").val() == null || $("#ilha_id").val() == null || error > 0) {
                ...
                $.ajax({
                    data: data,
                    url: "{{ route('PostCircularesStore', [ 'user' => Auth::user()->id ]) }}",
                    method: "POST",
                    processData: false,
                    contentType: false,
