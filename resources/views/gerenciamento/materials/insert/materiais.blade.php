...
<div class="page-container">
    ...
    <div class="page-content">
        ...
        <ul class="breadcrumb">
            <li><a href="#">Menu</a></li>
            <li> <a href="{{url()->previous()}}"> Gerenciamento </a></li>
        ...
        <div class="content-frame">
            ...
            <div class="content-frame-top">
                <div class="page-title">
                    <a href="{{url()->previous()}}"><h2><span class="fa fa-arrow-circle-o-left"></span> Incluir Material</h2></a>
                </div>
                ...
                <div class="panel panel-colorful">
                    ...
                    <div class="page-content-wrap" style='background-color:#f5f5f5 '>
                        ...
                        <div class="panel-body col-md-12">
                            <div class="form-row">
                                <form method="POST" enctype="multipart/form-data" class="form-horizontal col-md-12" onsubmit="return false" id="Material">
                                    @csrf
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select multiple required class="form-control select" id="cargo_id" name="cargo_id" onchange="getIlhas(this)">
...
<script type="text/javascript">
    function save() {
        ...
        if($("#cargo_id").val() == null || $("#ilha_id").val() == null || error > 0) {
            ...
            $.ajax({
                data: data,
                url: "{{ route('PostMateriaisStore', [ 'user' => Auth::id() ]) }}",
                method: "POST",
                processData: false,
                contentType: false,
