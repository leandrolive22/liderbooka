        ...
        <div class="content-frame">
            ...
            <div class="content-frame-top">
                <div class="page-title">
                    <a href="{{url()->previous()}}">
                        <h2><span class="fa fa-arrow-circle-o-left"></span> Incluir Roteiro</h2>
                    </a>
                </div>
                                        ...
                                        <div class="panel panel-primary">
                                                ...
                                                <form method="POST" enctype="multipart/form-data"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input required type="text" name="name" class="form-control"
                                                            id="name" placeholder="Título / Assunto">
                                                    </div>
                                                    {{-- ilhas --}}
                                                    <div class="form-group">
                                            ...
                                            <div class="panel panel-default form-group">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-12">
                                                            <label>Selecione a Roteiro</label>
                                                            <input type="file" class="" name="script"
...
<script type="text/javascript">
    function save() {
        ...
        if($("#cargo_id").val() == null || $("#ilha_id").val() == null || error > 0) {
            ...
            $.ajax({
                data: data,
                url: "{{ route('PostRoteirosStore', [ 'user' => Auth::id() ]) }}",
                method: "POST",
                processData: false,
                contentType: false,
