    ...
    <div class="panel panel-{{Auth::user()->css}}">
        <div class="panel-body">
            ...
            <div class="widget widget-default widget-padding-sm">
                ...
                {{-- feedback  --}}
                <div class="widget-buttons widget-c1" id="time">
                    <div class="form-group text-center">
                    <h4><strong> Trending Topics   </strong></h4>
                    @foreach ($materiaisClicados AS $clicados)
                            <div class="list-group border-bottom p1">
                              <div class="text-center">
                                <iframe width="220" height="115"
                                src="{{asset($clicados->file_path)}}">
                                </iframe>
                              </div>
                            </div>
                    @endforeach        
