...
<div class="page-container">
    ...
    <div class="page-content">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="#">Monitoria e Evolução Por Operador</a></li>
                ...
                <div class="col-md-12">
                                ...
                                <div class="panel panel-default tabs">
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li class="active"><a href="#tab-first" role="tab" data-toggle="tab">Buscar Monitoria e Evolução Por Operador</a></li>
                                    </ul>
                                    {{-- <li id="tab-fisrt"> --}}
