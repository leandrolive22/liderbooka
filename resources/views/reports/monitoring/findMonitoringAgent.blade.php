...
<div class="page-container">
    ...
    <div class="page-content">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="#">Monitoria e Evolução Por Agente</a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        <div class="panel panel-default tabs">                            
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="active"><a href="#tab-first" role="tab" data-toggle="tab">Buscar Monitoria e Evolução Por Agente</a></li>
                            </ul>
                            {{-- <li id="tab-fisrt"> --}}
                                ...
                                @csrf
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <label  for="supers">Agente</label>
                                            <select data-live-search="true" name="supers" id="supers" onchange="$('#formSearch').prop('action','{{asset('monitoring/PostFeedbacksEvolutionOperator')}}'+'/'+$(this).val());" placeholder="Selecione o Agente" class="form-control select">
                                                <option value="0">Selecione um Agente</option>
                                                @forelse ($supers as $item)
                                                    <option value="{{$item->id}}">{{$item->name}}</option>
                                                @empty
                                                    <option value="0" disabled>Nenhum Agente encontrado</option>
                                                @endforelse
                                            </select>
                                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="panel panel-default">
                            ...
                            @else
                                <h3 class="text-center">Nenhum dado disponível</h3>
                            @endif
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Monitorias por Agentes e Por Período</h3>
...
@section('Javascript')
    ...
    @if(isset($results))
        ...
        "-": "0",
        @forelse($results as $item)
            "{{date('d/m H:i',strtotime($item->date))}}": "{{$item->media}}",
        @empty   
            "N/D": "0",
        @endforelse
    ...
    @endif
        $("#btnSearch").click(function(){
            ...
            $("#formSearch").attr("action","{{ asset('manager/report/monitoring/agent/evolution/') }}/"+$("select#supers").val())

            if(error === 0) {
                $("#formSearch").submit()
            } else {
                $("#btnSearch").html('Buscar<span class="fa fa-search fa-right"></span>')
            }
        });
    </script>
@endsection
