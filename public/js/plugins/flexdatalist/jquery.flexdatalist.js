...
jQuery.fn.flexdatalist = function (_option, _value) {
    ...
    if (typeof _option === 'string' && _option !== 'reset') {
        if (typeof this[0] === 'object' && typeof this[0].fvalue !== 'undefined') {
            ...
            // Add value
                ...
                if (typeof _value === 'undefined') {
                    return target.debug('Valor procuradp to add!');
                }
                target.fvalue.add(_value);
            // Toggle value
            } else if (_option === 'toggle') {
                if (typeof _value === 'undefined') {
                    return target.debug('Valor procuradp to toggle!');
                }
                target.fvalue.toggle(_value);
            // Remove value
            } else if (_option === 'remove') {
                if (typeof _value === 'undefined') {
                    return target.debug('Valor procuradp to remove!');
                }
    ...
    var _options = $.extend({
        ...
        noResultsText: 'Tag "{keyword}" não cadastrada. Pressione enter para cadastrar .',
